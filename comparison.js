 ...
 * !Always use strict equality operators unless you fuly understand the different behavior of the standard equaity operators
...
let val9 = ('42' == 42); // '==' not strict comparison does a type convertion so string 42 is equal to string 42. See special cases consulting source in line 4.
let val10 = ('42' === 42); // '===' strict comparison does not do type convertion so type string 42 is not equal to type number 42. See special cases consulting source in line 4.
